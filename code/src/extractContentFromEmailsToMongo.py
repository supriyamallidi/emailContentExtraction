            ...
            for part in msg.walk():
                if part.get_content_type() == "text/plain":
                    ...
                    if nested_attachment_name and nested_attachment_content:
                        ...
                        nested_attachment.update(process_attachment(nested_attachment_name, nested_attachment_content))
...
def process_attachment(attachment_name, attachment_content):
    ...
    ext = os.path.splitext(attachment_name)[1].lower() if attachment_name else ''
    try:
    ...
    try:
        ...
        for attachment in attachments:
            ...
            if attachment_content:  # Process even if attachment_name is None
                ...
                processed_attachment.update(process_attachment(attachment_name, attachment_content))
    ...
    try:
        ...
        if email_data:
            ...
            if result.upserted_id:
                print(f"Inserted new document for {file_path} (ID: {result.upserted_id})")
            else:
...
if __name__ == "__main__":
    msg_folder_path = r"E:\genaiProject\outputEmails"
